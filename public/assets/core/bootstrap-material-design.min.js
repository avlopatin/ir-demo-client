              ...
              o.hasClass(p.DROPDOWN_ITEM)
                ...
                : (o.addClass(p.ACTIVE),
                  ...
                  o
                    ...
                    .addClass(p.ACTIVE)),
                e(this._scrollElement).trigger(_.ACTIVATE, { relatedTarget: t })
            }),
            (f._clear = function() {
              e(this._selector)
                .filter(m.ACTIVE)
          ...
          return (
            ...
            (s.resolveMdbFormGroupSizing = function() {
              if (this.config.convertInputSizeVariations)
                for (var e in a)
                  this.$element.hasClass(e) && this.$bmdFormGroup.addClass(a[e])
            }),
                ...
                ;(n || o) &&
                  ...
                  this.$element.on(this.config.trigger.end, function() {
                    t.$decorator &&
                      ...
                      'off' === t.$decorator.data('animating') && t.rippleOut())
                  }))
              }
            }),
